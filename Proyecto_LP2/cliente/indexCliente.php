...
if ($conn && !$conn->connect_error) {
    ...
    // 2. CONSULTA 1: Contar total de pedidos de este cliente
    ...
    // 3. CONSULTA 2: Obtener el último libro solicitado
    // Une las tablas pedido, detalle y libro para sacar el nombre
...
<body class="admin-body">
    ...
    <aside class="sidebar">
        <div class="sidebar-header">
            ...
            <A href="perfil.php"> MIEMBRO <span class="highlight">UDH</span></A>
        </div>
